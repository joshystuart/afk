...
- [x] Dimension 4 Typography: FLAG — 3 font weights (400/500/600) are pre-existing theme values, no new roles introduced
- [x] Dimension 5 Spacing: FLAG — 20px not in standard set, pre-existing `GeneralSettings.tsx` pattern
