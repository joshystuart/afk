...
const mockSessions = {
  runningDual: {
    ...
    branch: 'main',
    port: 7681,
    terminalUrl: 'http://localhost:7681',
  ...
  runningTwo: {
    ...
    branch: 'feature/v2',
    port: 7683,
    terminalUrl: 'http://localhost:7683',
    imageName: 'afk-python:latest',
    createdAt: dayAgo,
    updatedAt: now,
  },
  stopped: {
  ...
  noRepo: {
    ...
    branch: 'main',
    port: 7685,
    terminalUrl: 'http://localhost:7685',
    imageName: 'afk-node:latest',
    createdAt: hourAgo,
    updatedAt: now,
  },
